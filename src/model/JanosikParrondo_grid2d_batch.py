...
exp_desc = "janosik-parrondo_grid_"+str(grid_width)+'x'+str(grid_height)+"_"+str(batch_run.iterations)+"runs_"+str(batch_run.max_steps)+"steps_"+str(agen_nums[0])+"agents"
#%% run the experiment
if __name__ == "__main__":
    ...
    # rd.columns = ['num_agents', 'default_policy', 'default_eps', 'default_boost', 'Run', 'Gini index', 'init_wealth']
